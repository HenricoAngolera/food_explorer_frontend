              ...
              <Cards>
                {mainCourses &&
                  mainCourses.map(mainCourse => (
                    <CardData
                      key={String(mainCourse.id)}
                      image={`${api.defaults.baseURL}/files/${mainCourse.image}`}
                      name={mainCourse.name}
                      description={mainCourse.description}
                      price={mainCourse.price}
                      isbiggerfont
                      onClick={() => handleDetails(mainCourse.id)}
                      dishId={mainCourse.id}
                    />
                  ))}
              </Cards>
            </Section>
              ...
              <Cards>
                {drinks &&
                  drinks.map(drink => (
                    <CardData
                      key={String(drink.id)}
                      image={`${api.defaults.baseURL}/files/${drink.image}`}
                      name={drink.name}
